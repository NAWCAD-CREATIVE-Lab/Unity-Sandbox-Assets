Scriptable objects allowing for the creation of variables, references and events inside the Unity Asset folder.

Sandbox Assets can be read, written to and reacted to by Monobehaviour scripts in scenes.
